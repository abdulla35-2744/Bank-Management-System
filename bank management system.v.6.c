...
///Using function for print account number,balance
void printlist(){
...
///printing ten account holders account number and balance...
             ...
             for(counter=0;counter<=9;counter++){
                 if(accountholder[counter].account_number!=0){
                    ...
                    printf("Account number of Account_holders:%d  Account balance of Account_holders: %f\n",accountholder[counter].account_number,accountholder[counter].balance);
                 }
                else{
                    printf("\n\n\n");
               }
